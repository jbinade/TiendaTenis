            ...
            <div class="contenido-tabla">
                ...
                <div class="tabla">
                    ...
                    <table>
                        <tr id="campos">
                            <th>DNI</th>
                            <th><a href="clientes.php">Nombre</a><br>Ord. ASC</th>
                            <th>Apellidos</th>
                            <th>Dirección</th>
                            <th>Localidad</th>
                            <th>Provincia</th>
...
<?php
                        ...
                        try {
                            ...
                            $stmt = $conexion->prepare("SELECT * FROM clientes WHERE rol = 'usuario' AND activo = 1 ORDER BY nombre ASC LIMIT ".$inicio."," .$PAGS);
                            $stmt->execute();
                    ...
                    if ($total_paginas > 1) {
                        for ($i = 1; $i <= $total_paginas; $i++) {
                            if ($pagina == $i) {
                                ...
                                echo "<a href='clientesAsc.php?pagina=$i'>$i</a> ";
                            }
                        }
                    }
