...
<?php
                        ...
                        try {
                            ...
                            $stmt = $conexion->prepare("SELECT * FROM categorias WHERE activo = 1 AND codcategoriapadre IS NULL LIMIT ".$inicio."," .$PAGS);
                            $stmt->execute();
                    ...
                    if ($total_paginas > 1) {
                        for ($i = 1; $i <= $total_paginas; $i++) {
                            if ($pagina == $i) {
                                ...
                                echo "<a href='listadocategorias.php?pagina=$i'>$i</a> ";
                            }
                        }
                    }
