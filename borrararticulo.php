...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt = $conexion->prepare('UPDATE articulos SET activo = 0 WHERE codigo = :codigo');
        $stmt->bindParam(':codigo', $codigo, PDO::PARAM_STR);
        $stmt->execute();

        header("Location: menuarticulos.php?articuloeliminado=OK");
...
<body>
    ...
    <div class="contenedor">
            ...
            <main class="contenido-principal">
                ...
                <form class="formulario" action="borrararticulo.php?codigo=<?php echo $codigo; ?>" method="post">

                    <h2>Eliminar Artículo</h2>

                    <div class="form-campos form-cambio-contraseña">

                        <label for="contraseña">¿Deseas eliminar este artículo?</label> 
