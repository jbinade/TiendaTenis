...
<?php
                        ...
                        try {
                            ...
                            $stmt = $conexion->prepare("SELECT * FROM pedidos WHERE activo = 1 LIMIT ".$inicio."," .$PAGS);
                            $stmt->execute();
                            ...
                            while ($res = $stmt->fetch(PDO::FETCH_OBJ)) {
                                ...
                                echo "<td><a href='verpedidoadmin.php?pedido=" . $res->idPedido . "'><img src='./images/editar.png' alt='Editar'></a></td>";
                                echo "</tr>";
                            }
                    echo "</table>";
