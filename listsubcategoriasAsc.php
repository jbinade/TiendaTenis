            ...
            <div class="contenido-tabla">
                ...
                <div class="tabla">
                    ...
                    <table>
                        <tr id="campos">
                            <th>Código</th>
                            <th><a href="listadosubcategorias.php">Nombre</a><br>Ord. ASC</th>
...
<?php
                        ...
                        try {
                            ...
                            $stmt = $conexion->prepare("SELECT * FROM categorias WHERE activo = 1 AND codcategoriapadre IS NOT NULL ORDER BY nombre ASC LIMIT ".$inicio."," .$PAGS);
                            $stmt->execute();
                    ...
                    if ($total_paginas > 1) {
                        for ($i = 1; $i <= $total_paginas; $i++) {
                            if ($pagina == $i) {
                                ...
                                echo "<a href='listsubcategoriasAsc.php?pagina=$i'>$i</a> ";
                            }
                        }
                    }
