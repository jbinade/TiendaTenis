            ...
            <div class="contenido-tabla">
                ...
                <div class="tabla">
                    ...
                    <table>
                        <tr id="campos">
                            <th>Código</th>
                            <th>Nombre <br><a href="listarticulosinactAsc.php">ASC</a> <a href="listarticulosinactDesc.php">DESC</a></th>
                            <th>Categoría</th>
                            <th>Precio</th>
...
<?php
                        ...
                        try {
                            ...
                            $stmt = $conexion->prepare("SELECT * FROM articulos WHERE activo = 0 LIMIT ".$inicio."," .$PAGS);
                            $stmt->execute();
                    ...
                    if ($total_paginas > 1) {
                        for ($i = 1; $i <= $total_paginas; $i++) {
                            if ($pagina == $i) {
                                ...
                                echo "<a href='listarticulosinact.php?pagina=$i'>$i</a> ";
                            }
                        }
                    }
