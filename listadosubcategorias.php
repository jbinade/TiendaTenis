            ...
            <div class="contenido-tabla">
                ...
                <div class="tabla">
                    ...
                    <table>
                        <tr id="campos">
                            <th>Código</th>
                            <th>Nombre <br><a href="listsubcategoriasAsc.php">ASC</a> <a href="listsubcategoriasDesc.php">DESC</a></th>
...
<?php
                        ...
                        try {
                            ...
                            $stmt = $conexion->prepare("SELECT * FROM categorias WHERE activo = 1 AND codcategoriapadre IS NOT NULL LIMIT ".$inicio."," .$PAGS);
                            $stmt->execute();
                    ...
                    if ($total_paginas > 1) {
                        for ($i = 1; $i <= $total_paginas; $i++) {
                            if ($pagina == $i) {
                                ...
                                echo "<a href='listadosubcategorias.php?pagina=$i'>$i</a> ";
                            }
                        }
                    }
