            ...
            <div class="contenido-tabla">
                ...
                <div class="tabla">
                    ...
                    <table>
                        <tr id="campos">
                            <th>Código</th>
                            <th><a href="listadoarticulos.php">Nombre</a><br>Ord. ASC</th>
                            <th>Categoría</th>
                            <th>Precio</th>
...
<?php
                        ...
                        try {
                            ...
                            $stmt = $conexion->prepare("SELECT * FROM articulos WHERE activo = 1 ORDER BY nombre ASC LIMIT ".$inicio."," .$PAGS);
                            $stmt->execute();
                    ...
                    if ($total_paginas > 1) {
                        for ($i = 1; $i <= $total_paginas; $i++) {
                            if ($pagina == $i) {
                                ...
                                echo "<a href='listarticulosAsc.php?pagina=$i'>$i</a> ";
                            }
                        }
                    }
