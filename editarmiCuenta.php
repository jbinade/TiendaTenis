        ...
        <body>
            ...
            <div class="contenedor">
                ...
                <main class="contenido-principal">
                    ...
                    <form class="formulario" action="editarmiCuenta.php" method="post">
                        ...
                        <div class="form-campos">
                            ...
                            <input class="campo campo-dni" type="text" name="direccion" id="direccion" value="<?php echo $direccion; ?>">
                        
                            <div class="campo-nombre">
                                <div class="nombre">
                                    <label for="localidad">Localidad</label>
                                    <input class="campo" type="text" name="localidad" id="localidad" value="<?php echo $localidad; ?>"> 
                                </div>
                                
                                <div class="apellidos">
                                    <label for="provincia">Provincia</label>
                                    <input class="campo" type="text" name="provincia" id="provincia" value="<?php echo $provincia; ?>"> 
                                </div>
                            </div>

                            <label for="telefono">Telefono</label>
                            <input class="campo campo-contraseña" type="tel" name="telefono" id="telefono" pattern="[0-9]{9}" value="<?php echo $telefono; ?>">
                            <?php 
        ...
        <main class="contenido-principal">
            ...
            <form class="formulario" action="editarmiCuenta.php" method="post">
                ...
                <div class="form-campos">
                    ...
                    <label for="dni">Dirección</label>
                    <input class="campo direccion" type="text" name="direccion" id="direccion" value="<?php echo $datos->direccion; ?>">

                    <div class="campo-nombre">
                        <div class="nombre">
                            <label for="localidad">Localidad</label>
                            <input class="campo" type="text" name="localidad" id="localidad" value="<?php echo $datos->localidad; ?>"> 
                        </div>
                        
                        <div class="apellidos">
                            <label for="provincia">Provincia</label>
                            <input class="campo" type="text" name="provincia" id="provincia" value="<?php echo $datos->provincia; ?>"> 
                        </div>
                    </div>

                    <label for="telefono">Telefono</label>
                    <input class="campo campo-contraseña" type="tel" name="telefono" id="telefono" pattern="[0-9]{9}" value="<?php echo $datos->telefono; ?>">
