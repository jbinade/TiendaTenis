...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt = $conexion->prepare('UPDATE articulos SET activo = 1 WHERE codigo = :codigo');
        $stmt->bindParam(':codigo', $codigo, PDO::PARAM_STR);
        $stmt->execute();

        header("Location: menuarticulos.php?articuloactivado=OK");
        
    } catch(PDOException $e) {
            echo 'Error al activar el articulo: ' . $e->getMessage();
    }
...
<body>
    ...
    <div class="contenedor">
            ...
            <main class="contenido-principal">
                ...
                <form class="formulario" action="activararticulo.php?codigo=<?php echo $codigo; ?>" method="post">

                    <h2>Activar Artículo</h2>

                    <div class="form-campos form-cambio-contraseña">

                        <label for="contraseña">¿Deseas activar este artículo?</label> 
