...
<?php
                        ...
                        try {
                            ...
                            $stmt = $conexion->prepare("SELECT * FROM clientes WHERE rol = 'empleado' AND activo = 1 LIMIT ".$inicio."," .$PAGS);
                            $stmt->execute();
                            ...
                            while ($res = $stmt->fetch(PDO::FETCH_OBJ)) {
                                ...
                                echo "<td><a href='editarempleado.php?dni=" . $res->dni . "'><img src='./images/editar.png' alt='Editar'></a></td>";
