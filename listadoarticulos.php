            ...
            <div class="contenido-tabla">
                ...
                <div class="tabla">
                    ...
                    <table>
                        <tr id="campos">
                            <th>Código</th>
                            <th>Nombre <br><a href="listarticulosAsc.php">ASC</a> <a href="listarticulosDesc.php">DESC</a></th>
                            <th>Categoría</th>
                            <th>Precio</th>
...
<?php
                        ...
                        try {
                            ...
                            $stmt = $conexion->prepare("SELECT * FROM articulos WHERE activo = 1 LIMIT ".$inicio."," .$PAGS);
                            $stmt->execute();
                            ...
                            while ($res = $stmt->fetch(PDO::FETCH_OBJ)) {
                                ...
                                echo "<td><a href='editararticulo.php?codigo=" . $res->codigo . "'><img src='./images/editar.png' alt='Editar'></a></td>";
                                echo "<td><a href='borrararticulo.php?codigo=" . $res->codigo . "'><img src='./images/borrar.jpg' alt='Borrar'></a></td>";
                                echo "</tr>";
                                echo "</tr>";
                            }
                    echo "</table>";
                    ...
                    if ($total_paginas > 1) {
                        for ($i = 1; $i <= $total_paginas; $i++) {
                            if ($pagina == $i) {
                                ...
                                echo "<a href='listadoarticulos.php?pagina=$i'>$i</a> ";
                            }
                        }
                    }
